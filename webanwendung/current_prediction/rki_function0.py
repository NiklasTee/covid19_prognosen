...
def AddBoolColumn(dataframename, columnname, boolname):
    mask = (boolname == dataframename[columnname])
    dataframename[boolname] = mask


def DailyCasesAggregator(df_name, from_ids, to_id):
